...
export default {
  content: [
    ...
    './src/lib/**/*.{js,ts,jsx,tsx,html,mdx}',
    './src/utils/**/*.{js,ts,jsx,tsx,html,mdx}',
    './src/data/**/*.{js,ts,jsx,tsx,html,mdx}',
    './src/types/**/*.{js,ts,jsx,tsx,html,mdx}',
    './src/store/**/*.{js,ts,jsx,tsx,html,mdx}',
    './src/services/**/*.{js,ts,jsx,tsx,html,mdx}',
    './src/**/*.tsx',
    './src/**/*.jsx',
    './src/**/*.ts',
    './src/**/*.js',
